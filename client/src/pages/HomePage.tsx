          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex justify-center mt-8">
                <Link
                  to="/collections"
                  className="inline-flex items-center justify-center !rounded-full border border-[#1a1a1a] bg-white px-8 py-3 text-sm font-semibold text-[#1a1a1a] transition hover:bg-[#1a1a1a] hover:text-white w-64 sm:w-auto"
                >
                  View All Products
                </Link>
              </div>
